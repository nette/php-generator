...
final class Helpers
{
	...
	{
		trigger_error(__METHOD__ . '() is deprecated, use (new Dumper)->dump().', E_USER_DEPRECATED);
	...
	{
		trigger_error(__METHOD__ . '() is deprecated, use (new Dumper)->format().', E_USER_DEPRECATED);
