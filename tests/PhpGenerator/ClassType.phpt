...
test('comprehensive class construction with properties, methods, constants, and traits', function () {
...
testException('setVisibility throws exception for unknown visibility', function () {
	(new ClassType)->addMethod('method')->setVisibility('unknown');
}, ValueError::class);


test('adding duplicate constants, properties, methods, and traits throws exceptions', function () {
	$class = new ClassType('Example');
...
test('overwrite parameter allows replacing existing constants, properties, and methods', function () {
	$class = new ClassType('Example');
	$class->addConstant('a', 1);
...
test('removing constants, properties, and methods works correctly', function () {
	$class = new ClassType('Example');
	$class->addConstant('a', 1);
