...
Assert::matchFile(__DIR__ . '/expected/Printer.class.expect', $printer->printClass($class));
Assert::matchFile(__DIR__ . '/expected/Printer.method.expect', $printer->printMethod($class->getMethod('first')));
...
Assert::matchFile(__DIR__ . '/expected/Printer.function.expect', $printer->printFunction($function));
...
Assert::matchFile(__DIR__ . '/expected/Printer.closure.expect', $printer->printClosure($closure));
